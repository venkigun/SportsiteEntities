...
namespace SportsSite
{
    ...
    public class EventType
    {
        ...
        public int AddOrUpdateEventType()
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.SaveEventType", conn);
        ...
        public EventType SelectById(int keyId)
        {
            try
            {
                this.Id = keyId;
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.GetEventType", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
        ...
        public int DeleteById(int keyId)
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.DeleteEventType", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
