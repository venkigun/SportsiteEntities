...
namespace SportsSite
{
    ...
    public class MediaType
    {
        ...
        public int AddOrUpdateMediaType()
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.SaveMediaType", conn);
        ...
        public MediaType SelectById(int keyId)
        {
            try
            {
                this.Id = keyId;
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.GetMediaType", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
        ...
        public int DeleteById(int keyId)
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.DeleteMediaType", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
