    ...
    public class Team
    {
        ...
        public int AddOrUpdateTeam()
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.SaveTeam", conn);
        ...
        public Team SelectById(int keyId)
        {
            try
            {
                this.Id = keyId;
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.GetTeam", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
        ...
        public int DeleteById(int keyId)
        {
            try
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.DeleteTeam", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlParameter IdParam = new SqlParameter();
                    IdParam.ParameterName = "@Id";
                    IdParam.SqlDbType = SqlDbType.Int;
